    ...
    return  @{
        ...
        PostgreSQL = @{
            ConnectionStrings = @{
                ...
                ((Get-ConnectionStringKeyByDatabaseTypes)[(Get-DatabaseTypes).Master])   = "Host=localhost; Port=5432; Username=postgres; Database=postgres; Pooling=true; Minimum Pool Size=10; Maximum Pool Size=50;"
            }
            ApiSettings       = @{
