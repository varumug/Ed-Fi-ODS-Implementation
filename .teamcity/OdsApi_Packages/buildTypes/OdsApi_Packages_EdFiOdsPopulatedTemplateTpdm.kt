...
object OdsApi_Packages_EdFiOdsPopulatedTemplateTpdm : BuildType({
    templates(OdsApi_Packages_CreateDatabaseTemplate)
    name = "EdFi.Ods.Populated.Template.TPDM"
    ...
    artifactRules = """
        ...
        Ed-Fi-ODS-Implementation\DatabaseTemplate\Database\EdFi.Ods.Populated.Template.TPDM.bak => result.zip!
    """.trimIndent()

    params {
        param("script.initdev.parameters", "-UsePlugins -NoDeploy")
        param("script.create.template.parameters", "")
        ...
        """.trimIndent())
        param("PackageId", "EdFi%odsapi.package.suffix%.Ods.Populated.Template.TPDM")
