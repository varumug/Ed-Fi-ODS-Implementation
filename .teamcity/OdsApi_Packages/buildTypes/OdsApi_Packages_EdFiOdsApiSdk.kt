...
object OdsApi_Packages_EdFiOdsApiSdk : BuildType({
    name = "EdFi.Ods.Api.Sdk"
    description = "Data Standard Only"
    ...
    params {
        ...
        param("NugetPackageId", "EdFi%odsapi.package.suffix%.OdsApi.Sdk")
    }
    ...
    steps {
        exec {
            ...
            arguments = """-m "%SdkGenerationApiMetadataUrl%" -v "%SdkCliVersion%" --core-only"""
        }
        dotnetRestore {
    ...
    dependencies {
        dependency(OdsApi_Utilities.buildTypes.OdsApi_Utilities_EdFiSdkGen) {
            snapshot {
